...
[![Total Skills](https://img.shields.io/badge/Total%20Skills-279%20Skills-emerald?style=for-the-badge)](#-full-279-skill-catalog)
[![Cross-Tool Compatibility](https://img.shields.io/badge/Compatible%20With-Antigravity%20|%20Claude%20Code%20|%20Cursor%20|%20Windsurf-indigo?style=for-the-badge)](#-compatibility)
[![PRs Welcome](https://img.shields.io/badge/PRs-Welcome-brightgreen?style=for-the-badge)](CONTRIBUTING.md)

**Turn any AI coding assistant into an elite Staff Engineer, Data Architect, AI Scientist, and Startup Co-founder.**

*A curated, standardized, production-grade library of **279 AI agent skills** featuring Garry Tan's GStack, Addy Osmani's Engineering Skills, Strix Cybersecurity, UI/UX Pro Max, 21st.dev Magic UI, and Big Tech enterprise architectures (Google, Microsoft, Meta, AWS, Netflix).*

[Quickstart](#-1-click-installation) • [What You Can Build](#-what-can-you-build) • [Who Is This For](#-who-is-this-for) • [Full Catalog (279 Skills)](#-full-279-skill-catalog) • [License](#-license)
...
Install all **279 skills** into any existing project or new repository in seconds:
...
| Role | How This Library Empowers You |
|---|---|
| **🎓 Students & Researchers** | Build complex academic projects, deep learning benchmarks in PyTorch 2.x, statistical time-series forecasting, and computer vision pipelines with zero boilerplate. |
...
## 📦 What's Inside? (Curated Sources & Toolkits)
...
## 📑 Full 279-Skill Catalog

See the comprehensive, searchable index in **[`SKILLS_INDEX.md`](SKILLS_INDEX.md)** with detailed descriptions and paths for all 279 skills organized across:
...
Contributions from the global open-source community are warmly welcomed! See [`CONTRIBUTING.md`](CONTRIBUTING.md) for instructions on adding new skills.

---

## 📜 License

Licensed under the **MIT License** — free for personal, commercial, and open-source use.
